  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-14 flex items-center justify-between px-6"
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Fusion 审查 */}
        <button onClick={() => navigate('/fusion')} className="flex items-center gap-1.5 text-xs font-mono px-2 py-1 rounded hover:bg-[rgba(180,200,255,0.04)] transition-colors" style={{ color: 'var(--text-muted)', border: '1px solid var(--border-default)' }} title="Fusion 审查">
          <Scale size={14} /> 审查
        </button>

        {/* 作战室 */}
        <button onClick={() => navigate('/ops')} className="flex items-center gap-1.5 text-xs font-mono px-2 py-1 rounded hover:bg-[rgba(180,200,255,0.04)] transition-colors" style={{ color: 'var(--text-muted)', border: '1px solid var(--border-default)' }} title="Ops 作战室">
          <Activity size={14} /> 作战室
        </button>

        {/* 模型熔断 */}
        <button onClick={() => navigate('/guard')} className="flex items-center gap-1.5 text-xs font-mono px-2 py-1 rounded hover:bg-[rgba(180,200,255,0.04)] transition-colors" style={{ color: 'var(--text-muted)', border: '1px solid var(--border-default)' }} title="模型熔断管理">
          <Shield size={14} /> 熔断
        </button>
